...
<html lang="id">
  <head>
    ...
    <!-- Title-->
    <title>Dental Clinic Website - Ditrois - Website and Software Development Company</title>
    <!-- Favicon-->
  ...
  <body>
            ...
            <ul class="navbar-nav navbar-nav-scroll">
              ...
              <li class="sb-dropdown"><a href="#">Services</a>
                <ul class="sb-dropdown-menu">
                  <li><a href="/service/dental">Dental Clinic Website</a></li>
                </ul>
              </li>
        ...
        <div class="row h-100 align-items-center justify-content-between">
          ...
          <div class="col-12 col-sm-10 col-md-6">
            <div class="welcome-content">
              ...
              <h2 class="wow fadeInUp" data-wow-duration="1s" data-wow-delay="300ms">Dental <br> Clinic Website.</h2>
          ...
          <div class="col-12 col-sm-9 col-md-6">
            <div class="welcome-thumb ms-xl-5 wow fadeInUp" data-wow-duration="1s" data-wow-delay="1s"><img src="{{ asset('img/illustrator/4.png') }}" alt=""></div>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="cool-facts-wrapper">
      <!-- Background Image -->
      <div class="cta-background-image"><img src="{{ asset('img/core-img/wm.png') }}" alt=""></div>
      <!-- Circle Animation -->
          ...
          <div class="col-12">
            <div class="pricing-table-switch mb-80 text-center wow fadeInUp" data-wow-duration="1000ms">
              <div class="form-check form-switch d-flex align-items-center justify-content-center ps-0 mb-0">
                <label class="form-check-label fz-16 fw-bold me-3" for="priceSwitching">Our Subdomain</label>
                <input class="form-check-input ms-0 mt-0" id="priceSwitching" type="checkbox">
                <label class="form-check-label fz-16 fw-bold ms-3 position-relative" for="priceSwitching">Private Domain<span class="badge bg-danger rounded position-absolute">+ 200k</span></label>
              </div>
            </div>
          </div>
          <div class="col-12">
                  ...
                  <div class="pricing-heading d-flex justify-content-between mb-5">
                    <div class="price"><span class="badge bg-primary rounded fz-12">Basic</span>
                      <div class="price-quantity">
                        <h2 class="mb-0 monthly-price">500k<span class="fz-12">Our Subdomain</span></h2>
                        <h2 class="mb-0 yearly-price">700k<span class="fz-12">Private Domain</span></h2>
                      </div>
                    </div>
                    <div class="price-icon"><img src="{{ asset('img/svg-icon/plant2.svg') }}" alt=""></div>
                  </div>
                  <div class="pricing-desc mb-5">
                    <ul class="list-unstyled mb-0">
                      <li>1-3 Pages</li>
                      <li>Fully Responsive Design</li>
                      <li>Basic SEO Optimation</li>
                      <li>Social Media Integration</li>
                      <li>Free SSL</li>
                      <li>3 Premium Themes</li>
                      <li>250 MB SSD Cloud Hosting</li>
                      <li>Direct Appointment to WhatsApp</li>
                      <li class="times">Access to Admin Dashboard</li>
                      <li class="times">Dinamic Dental Services</li>
                      <li class="times">Dinamic Dentist List</li>
                      <li class="times">Multi Language</li>
                      <li class="times">Access to Server</li>
                      <li class="times">Web Base Appointment System</li>
                      <li class="times">Fully Customize Design</li>
                    </ul>
                  </div>
                  <div class="pricing-btn"><a class="btn btn-primary" href="https://wa.me/6285161830939?text=Hi,%20Saya%20ingin%20website%20Dentist%20dengan%20plan%20Basic">Choose Plan</a></div>
                </div>
              </div>
              <!-- Single Pricing Plan-->
              <div class="col-12 col-sm-9 col-md-7 col-lg-4">
                <div class="card pricing-card monthly-plan active mb-30">
                  <div class="pricing-heading d-flex justify-content-between mb-5">
                    <div class="price"><span class="badge bg-warning rounded fz-12">Standard</span>
                      <div class="price-quantity">
                        <h2 class="mb-0 monthly-price">1.000k<span class="fz-12">Our Subdomain</span></h2>
                        <h2 class="mb-0 yearly-price">1.200k<span class="fz-12">Private Domain</span></h2>
                      </div>
                    </div>
                    <div class="price-icon"><img src="{{ asset('img/svg-icon/plant.svg') }}" alt=""></div>
                  </div>
                  <div class="pricing-desc mb-5">
                    <ul class="list-unstyled mb-0">
                      <li>1-6 Pages</li>
                      ...
                      <li>Free SSL</li>
                      <li>3 Premium Themes</li>
                      <li>500 MB SSD Cloud Hosting</li>
                      <li>Direct Appointment to WhatsApp</li>
                      <li>Access to Admin Dashboard</li>
                      <li>Dinamic Dental Services</li>
                  ...
                  <div class="pricing-btn"><a class="btn btn-warning" href="https://wa.me/6285161830939?text=Hi,%20Saya%20ingin%20website%20Dentist%20dengan%20plan%20Standard">Choose Plan</a></div>
                </div>
              </div>
              <!-- Single Pricing Plan-->
              <div class="col-12 col-sm-9 col-md-7 col-lg-4">
                <div class="card pricing-card monthly-plan mb-30 wow fadeInRight" data-wow-duration="1000ms">
                  <div class="pricing-heading d-flex justify-content-between mb-5">
                    <div class="price"><span class="badge bg-info rounded fz-12">Pro</span>
                      <div class="price-quantity">
                        <h2 class="mb-0 monthly-price">2.000k<span class="fz-12">Our Subdomain</span></h2>
                        <h2 class="mb-0 yearly-price">2.200k<span class="fz-12">Private Domain</span></h2>
                      </div>
                    </div>
                    <div class="price-icon"><img src="{{ asset('img/svg-icon/saving-money.svg') }}" alt=""></div>
                  </div>
                  <div class="pricing-desc mb-5">
                    <ul class="list-unstyled mb-0">
                      <li>1-12 Pages</li>
                      ...
                      <li>Free SSL</li>
                      <li>3 Premium Themes</li>
                      <li>1 GB SSD Cloud Hosting</li>
                      <li>Direct Appointment to WhatsApp</li>
                      <li>Access to Admin Dashboard</li>
                      <li>Dinamic Dental Services</li>
                      <li>Multi Language</li>
                      <li>Dinamic Dentist List</li>
                      <li>Access to Server</li>
                      <li>Web Base Appointment System</li>
                      <li>Fully Customize Design</li>
                    </ul>
                  </div>
                  <div class="pricing-btn"><a class="btn btn-info" href="https://wa.me/6285161830939?text=Hi,%20Saya%20ingin%20website%20Dentist%20dengan%20plan%20Pro">Choose Plan</a></div>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="client-feedback-slides">
              ...
              <div class="card feedback-card border-0 p-2 shadow-sm">
                <div class="card-body p-5 p-sm-4 p-md-5">
                  <div class="client-info d-flex align-items-center">
                    <div class="client-thumb rounded-circle me-2 position-relative"><img class="rounded-circle" src="{{ asset('img/bg-img/t1.png') }}" alt=""><span class="rounded-circle"><i class="bi bi-check"></i></span></div>
            ...
            <div>
              <div class="card feedback-card border-0 p-2 shadow-sm">
                <div class="card-body p-5 p-sm-4 p-md-5">
                  <div class="client-info d-flex align-items-center">
                    <div class="client-thumb rounded-circle me-2 position-relative"><img class="rounded-circle" src="{{ asset('img/bg-img/t2.png') }}" alt=""><span class="rounded-circle"><i class="bi bi-check"></i></span></div>
                    <div class="client-name">
                      <h6 class="fz-14 mb-0">Lim Jannat</h6>
                      <p class="mb-0 fz-12">@lim_jannat</p>
                    </div>
            ...
            <div>
              <div class="card feedback-card border-0 p-2 shadow-sm">
                <div class="card-body p-5 p-sm-4 p-md-5">
                  <div class="client-info d-flex align-items-center">
                    <div class="client-thumb rounded-circle me-2 position-relative"><img class="rounded-circle" src="{{ asset('img/bg-img/t3.png') }}" alt=""><span class="rounded-circle"><i class="bi bi-check"></i></span></div>
                    <div class="client-name">
                      <h6 class="fz-14 mb-0">Lim Jannat</h6>
                      <p class="mb-0 fz-12">@lim_jannat</p>
                    </div>
      ...
      <div class="container">
        <div class="row g-4 g-lg-5">
          ...
          <div class="col-12 col-sm-6 col-lg-3">
            <div class="footer-widget-area"><a class="d-block mb-4" href="index.html"><img src="{{ asset('img/ditrois.png') }}" alt=""></a>
          ...
          <div class="col-12 col-sm-6 col-lg-3">
            <div class="footer-widget-area">
              ...
              <p class="lh-base mb-3">Ditrois. <br> Jl. Udayana, Buruan, Kec. Blahbatuh, Kabupaten Gianyar, Bali 80581</p>
              <p class="mb-0">Call: +62 851 6183 0939 <br> Email: help@ditrois.com</p>
              <!-- Footer Social Icon -->
      ...
      <div class="container">
        <div class="copywrite-wrapper mt-5 rounded d-lg-flex align-items-lg-center justify-content-lg-between">
          ...
          <div class="copywrite-text text-center text-lg-start mb-3 mb-lg-0 me-lg-4">
            <p class="mb-0">2022 &copy; All rights reserved by <a href="#" target="_blank">Ditrois</a></p>
          </div>
          <!-- Footer Nav -->
          ...
          <div class="language-dropdown text-center text-lg-end">
            ...
            <div class="dropdown-menu dropdown-menu-end">
                <a class="dropdown-item" href="#">
                    <span class="me-2 flag-icon flag-icon-id"></span>
                    Indonesia
                </a>
                <a class="dropdown-item" href="#">
                    <span class="me-2 flag-icon flag-icon-us"></span>
                    English
                </a>
            </div>
          </div>
